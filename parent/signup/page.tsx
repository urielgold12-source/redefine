  ...
  return (
    <main className="min-h-screen bg-[#050508] text-white flex flex-col items-center justify-center p-6">
      ...
      <div className="flex gap-2 mb-10">
        {[1, 2, 3].map((s) => (
          <div key={s} className={`h-1 w-16 rounded-full transition-all ${s <= step ? "bg-purple-500" : "bg-white/10"}`} />
        ))}
      </div>
        ...
        {step === 1 && (
          <div className="flex flex-col gap-4">
            ...
            <input
              ...
              className="bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 transition"
            />
            <input
              type="email"
            ...
            <button
              ...
              className="mt-4 bg-purple-600 hover:bg-purple-500 transition text-white font-black py-3 rounded-xl disabled:opacity-30"
            >
              Continue →
            </button>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/10 rounded-xl pl-8 pr-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 transition"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button
                ...
                className="flex-1 bg-purple-600 hover:bg-purple-500 transition text-white font-black py-3 rounded-xl disabled:opacity-30"
              >
                Continue →
              </button>
            </div>
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4">
              ...
              <div key={item.app} className="flex items-center justify-between bg-white/5 border border-white/10 rounded-xl px-4 py-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    step="0.01"
                    className="w-16 bg-white/10 border border-white/10 rounded-lg px-2 py-1 text-white text-sm text-center focus:outline-none focus:border-purple-500"
                  />
            ...
            <div className="flex gap-3 mt-4">
              ...
              <Link href="/parent/dashboard" className="flex-1 bg-purple-600 hover:bg-purple-500 transition text-white font-black py-3 rounded-xl text-center">
                Launch Redefine 🚀
              </Link>
            </div>
          </div>
