...
export default function KidLogin() {
  ...
  return (
    <main className="min-h-screen bg-[#020817] text-white flex flex-col items-center justify-center p-6">
            ...
            {[1,2,3,4,5,6,7,8,9,"⌫",0,"✓"].map((key) => (
              <button
                ...
                className={`py-4 rounded-xl text-lg font-bold transition ${
                  key === "✓" ? "bg-cyan-600 hover:bg-cyan-500 text-white" :
                  key === "⌫" ? "bg-white/10 hover:bg-white/20 text-gray-400" :
      ...
      <p className="text-gray-600 text-xs mt-6">Don&apos;t know your PIN? Ask your parent.</p>
      <Link href="/parent/login" className="text-cyan-400 text-sm mt-3 hover:underline">I&apos;m a parent →</Link>
